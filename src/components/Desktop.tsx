...
export const Desktop: React.FC = () => {
  ...
  return (
    <div className="desktop-bg">
      <div className="desktop-icons-container absolute top-4 left-4 bottom-16 grid gap-3 overflow-y-scroll pb-8" style={{ gridTemplateColumns: 'repeat(3, 80px)', gridAutoRows: 'min-content' }}>
